...
We use the [Hugo Book](https://themes.gohugo.io/themes/hugo-book/) theme, which allows you to inject [these shortcodes](https://book.alxs.dev/docs/content/shortcodes/) into the Markdown files.
